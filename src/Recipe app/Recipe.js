...
const Recipe = () => {
//    let urlRecipe = "https://themealdb.com/api/json/v1/1/search.php?s=";
// let urlRecipe = "www.themealdb.com/api/json/v1/1/categories.php";
  ...
  const searchBtn = async () => {
    try {
      const options = {
        ...
        console.log(data)
        // const meals = data.categories.map((datas)=>{
        //     console.log(datas)
        // })
    // setParagraph(url)
    // console.log(meals)
        ...
        <div className="form-bg">
          <div>
            <input
              type="text"
              autoComplete="off"
              placeholder="Recipe search for your favorite meal"
              name="search"
              value={search}
